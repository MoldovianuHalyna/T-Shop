  ...
  return (
    <Formik
      ...
      onSubmit={(values, helpers) => {
        onSearchChange?.(values.query);
        helpers.setSubmitting(false);
      }}
    >
      {({ setFieldValue }) => (
        <Form className="flex flex-col gap-4 rounded-[24px] bg-bg/70 p-5 shadow-[0_20px_48px_-28px_rgba(99,102,241,0.9)] backdrop-blur-xl">
